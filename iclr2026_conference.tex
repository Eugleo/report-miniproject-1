...
Each algorithm is applied to the full model with no information about how it was trained or where biology knowledge might be stored.

Our interest is not in comparing methods against each other, but in whether, \emph{within each method}, more disentangled models yield better retain--forget trade-offs.
